...
if __name__ == '__main__':
    ...
    # 将要转换的词库添加在这里就可以了
    # o = [u'明星【官方推荐】.scel',]
    o='/Users/ozintel/Library/Containers/com.tencent.xinWeChat/Data/Library/Application Support/com.tencent.xinWeChat/2.0b4.0.9/ecdb45a753ffc95b1e5405fcdb14ada5/Message/MessageTemp/0379fea210a4600d66c9b1bda53d9a5e/File/财经金融词汇大全【官方推荐】(3).scel'
    
    f=open(o,encoding='gb2312',errors='ignore')
    for x in f:
        print(x)
    ...
    #
    #     # 保存结果
    # f = open('amuse.txt', 'w',errors='ignore')
    # for word in GTable:
